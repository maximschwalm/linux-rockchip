...
#define SENSOR_PREVIEW_W                     (800-16)
#define SENSOR_PREVIEW_H                     (600-12)
#define SENSOR_PREVIEW_FPS                   7000     // 15fps 
#define SENSOR_FULLRES_L_FPS                 7000      // 7.5fps
#define SENSOR_FULLRES_H_FPS                 7000      // 7.5fps
...
#define  SP2518_P0_0xde  0x98 //88	//0x95 modify by sp_yjp,20120814
//auto lum
...
static struct rk_sensor_reg sensor_init_data[] = {
	{0xfd,0x00},
	{0x1b,0x0A},//maximum drv ability //0x02 modify by sp_yjp,20120809 option:0x02 0x0A 0x12 0x1A
	{0x0e,0x01},
	...
	{0xf6,0x38},
	{0xfd,0x01},
	{0x94,0x80},//f8 //0xc0 //zouyu 20130816
	{0x95,0x38},
	{0x9c,0x6c},
	{0x9d,0x38},	
	#if 0
	...
	{0x5a,0xe0},//c0//raw_rb_fac_outdoor
	{0xc4,0xc0},//80//60raw_rb_fac_indoor
	{0x43,0x60},//40raw_rb_fac_dummy  
	{0xad,0x20},//raw_rb_fac_low  

	{0x4f,0xe0},//c0raw_gf_fac_outdoor
	{0xc3,0xc0},//8060raw_gf_fac_indoor
	{0x3f,0x60},//4040raw_gf_fac_dummy
	{0x42,0x20},//raw_gf_fac_low
	{0xc2,0x15},

	{0xb6,0xe0},//a0//raw_gflt_fac_outdoor
	{0xb7,0xc0},//80//60raw_gflt_fac_normal
	{0xb8,0x60},//40raw_gflt_fac_dummy
