...
#define GPIO_EXPANDER_BASE	(PIN_BASE+NUM_GROUP*GPIO_BANKS)

#if defined(CONFIG_GPIO_PCA9555)
#define	PCA9555_P00 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 0)
#define	PCA9555_P01 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 1)
#define	PCA9555_P02 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 2)
#define	PCA9555_P03 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 3)
#define	PCA9555_P04 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 4)
#define	PCA9555_P05 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 5)
#define	PCA9555_P06 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 6)
#define	PCA9555_P07 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 7)

#define	PCA9555_P10 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 10)
#define	PCA9555_P11 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 11)
#define	PCA9555_P12 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 12)
#define	PCA9555_P13 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 13)
#define	PCA9555_P14 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 14)
#define	PCA9555_P15 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 15)
#define	PCA9555_P16 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 16)
#define	PCA9555_P17 (GPIO_EXPANDER_BASE + 0*NUM_GROUP + 17)
#endif
