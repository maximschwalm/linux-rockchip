...
#define CONFIG_GPIO_PCA9555_NUM	16
#else
#define CONFIG_GPIO_PCA9555_NUM	0
#endif
#define PCA9555_GPIO_EXPANDER_BASE	(TPS65910_GPIO_EXPANDER_BASE + CONFIG_GPIO_TPS65910_NUM)

//定义GPIO的PIN口最大数目。CONFIG_SPI_FPGA_GPIO_NUM表示FPGA的PIN脚数。
#define ARCH_NR_GPIOS  (PIN_BASE + CPU_TOTOL_GPIO_NUM + TCA6424_TOTOL_GPIO_NUM + WM831X_TOTOL_GPIO_NUM + CONFIG_SPI_FPGA_GPIO_NUM + CONFIG_GPIO_WM8994_NUM + CONFIG_GPIO_TPS65910_NUM + CONFIG_GPIO_PCA9555_NUM)
